...
namespace PLD
{
	...
	{
		public SmokePlumeParticleSystem(LemmingDeath game, int howManyEffects)
		...
		protected override Vector2 PickRandomDirection()
		{
			...
			float radians = LemmingDeath.RandomBetween(
		...
		protected override void InitializeParticle(Particle p, Vector2 where)
		{
			...
			p.Acceleration.X += LemmingDeath.RandomBetween(10, 50);
		}
	}
}
=======
