...
namespace PLD.Camera
{
    public class Camera2d
    {
        ...
        public Vector2 Pos
        {
            ...
            {
                _pos = value;
                // Don't need any of this I don't think... I want to MOVE IN ALL THE SPACES
                /**
                ...
                if (_pos.X > rightBarrier)
                    _pos.X = rightBarrier;
                 **/
                // Y moves in a negative space... this needs to be inversed somehow...
                // Chris Kelner - TODO - Removing for now
